...
class Profile extends MY_Controller{
    ...
    public function getProfile(){
        ...
        $parameters['select'] = 'username,firstname,lastname,email,phone,username,bu_password';
		$profileDetails = $this->MY_Model->getRows('users',$parameters,'obj');

        $parameters['where'] = array('fk_user_id' => $user_id);
        $parameters['select'] = 'mobile_number,address,job_discipline';
		$profileAdditionalDetails = $this->MY_Model->getRows('additional_user_information',$parameters,'obj');

        $data['details'] = $profileDetails;
        $data['Additional_Details'] = $profileAdditionalDetails;
