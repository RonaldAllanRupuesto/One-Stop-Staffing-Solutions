              ...
              <div class="modal-dialog modal-s" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <label for="price">Price1: <span class="required">*</span></label>
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text">₱</span>
                          </div>
            ...
            <div class="table-responsive">
              <div class="col-sm-12">
                <table class="table table-bordered table-striped dataTable books_table" role="grid" aria-describedby="example1_info">
                  <thead>
                    <th class="header-title">ID</th>
                    <th class="header-title">Document Name</th>
                    <th class="header-title">Sequence</th>
